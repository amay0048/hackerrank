...
public class MainTest {
    ...
    private String solution = "solution_04_quartile_range";

    private BufferedReader getTestFile(String caseName, Direction direction) throws Exception {
        String filePath = new File("").getAbsolutePath();
        filePath = filePath.concat("/src/basic_stats/" + this.solution + "/test/" + caseName + "/" + direction + ".txt");
    ...
    private String getCaseOutput(String caseName) throws Exception {
        String filePath = new File("").getAbsolutePath();
        filePath = filePath.concat("/src/basic_stats/" + this.solution + "/test/" + caseName + "/" + Direction.OUTPUT + ".txt");
