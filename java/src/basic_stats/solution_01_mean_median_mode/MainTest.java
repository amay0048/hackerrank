...
public class MainTest {
    ...
    private BufferedReader getTestFile(String caseName, Direction direction) throws Exception {
        ...
        filePath = filePath.concat("/src/basic_stats/solution_01_mean_median_mode/test/" + caseName + "/" + direction + ".txt");
    ...
    private String getCaseOutput(String caseName) throws Exception {
        String filePath = new File("").getAbsolutePath();
        filePath = filePath.concat("/src/basic_stats/solution_01_mean_median_mode/test/" + caseName + "/" + Direction.OUTPUT + ".txt");
