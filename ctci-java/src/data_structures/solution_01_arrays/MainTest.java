...
public class MainTest {
    ...
    private BufferedReader getTestFile(String caseName, Direction direction) throws Exception {
        ...
        filePath = filePath.concat("/src/data_structures/solution_01_arrays/test/" + caseName + "/" + direction + ".txt");
    ...
    private String getCaseOutput(String caseName) throws Exception {
        String filePath = new File("").getAbsolutePath();
        filePath = filePath.concat("/src/data_structures/solution_01_arrays/test/" + caseName + "/" + Direction.OUTPUT + ".txt");
